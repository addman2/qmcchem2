...
("jastrow_jbh_size"                , "integer"       , ""                   ),
("jastrow_jbh_ee"                  , "real"          , "(nucl_num)"         ),
("jastrow_jbh_en"                  , "real"          , "(nucl_num)"         ),
("jastrow_jbh_c"                   , "real"          , "(jbh_size,nucl_num)"),
("jastrow_jbh_m"                   , "integer"       , "(jbh_size,nucl_num)"),
("jastrow_jbh_n"                   , "integer"       , "(jbh_size,nucl_num)"),
("jastrow_jbh_o"                   , "integer"       , "(jbh_size,nucl_num)"),
...
("jastrow_mur_type"                , "integer"       , ""                   ),
("jastrow_mu_r_ct"                 , "real"          , ""                   ),
